...
public class TaskServiceTest {
    ...
    class EcpTesting {
        ...
        @Test
        @DisplayName("Save task with a invalid date")
    ...
    class BvaTesting {
        ...
        public void saveTaskWithInvalidDateLowerBound() {
            Assertions.assertThrows(IllegalArgumentException.class, () -> new Task("Title", new Date(1577836799000L), new Date(1577836799000L), 1));
            Assertions.assertEquals(1, service.getTasks().size());
        }
        ...
        public void saveTaskWithInvalidDateUpperBound() {
            Assertions.assertThrows(IllegalArgumentException.class, () -> new Task("Title", new Date(2524608000000L), new Date(2524608000000L), 1));
            Assertions.assertEquals(1, service.getTasks().size());
        }
    }
}